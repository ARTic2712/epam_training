...
namespace TaxiLib.Classes
{
    public class Truck:AbstractCar,Interfaces.ICar, Interfaces.IOptionable 
    {
        ...
        public Truck(Guid id, string firm, string model,string registrationNumber, double weight, double fuelcost, int maxspeed, decimal carrying, Enums.CarcassTruck carcass, decimal volume)
